        ...
        {view==="dashboard" && (
          <div className="fu">
            <div style={{marginBottom:22}}>
              <p style={{fontSize:13,color:"var(--text2)",marginBottom:4}}>{new Date().toLocaleDateString("es-MX",{weekday:"long",day:"numeric",month:"long"})}</p>
              <h2 style={{fontFamily:"-apple-system,'SF Pro Display',sans-serif",fontSize:32,fontWeight:700,letterSpacing:"-.5px",color:"var(--text)",lineHeight:1.1,marginBottom:2}}>
                Buenos días,
              </h2>
              <span style={{fontFamily:"-apple-system,'SF Pro Display',sans-serif",fontSize:28,fontWeight:300,fontStyle:"italic",letterSpacing:"-.3px",color:"var(--rose)"}}>
