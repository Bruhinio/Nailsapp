            ...
            <div className="card" style={{borderRadius:16,overflow:"hidden",marginBottom:14}}>
              <div style={{display:"flex"}}>
                {[
                  ...
                  <div key={s.l} style={{flex:1,textAlign:"center",padding:"12px 0",borderRight:i<arr.length-1?".5px solid var(--ios-sep)":"none"}}>
                    <div style={{fontSize:19,fontWeight:700,color:s.c}}>{s.v}</div>
                    <div style={{fontSize:10,color:"var(--ios-label2)",marginTop:2}}>{s.l}</div>
                  </div>
                ))}
              </div>
            </div>
