...
const G = () => (
  <style>{`
    ...
    *{font-family:'DM Sans',sans-serif} h1,h2,h3,h4{font-family:'Cormorant Garamond',serif}
    ...
    /* ─ Dark mode ─ */
    body.dark{background:#1A1018!important}
    body.dark .page{background:#1A1018}
    body.dark .card{background:#2A1E28;color:#F0E4EC;border:1px solid #3A2836}
    body.dark .topbar{background:#2A1E28;border-color:#3A2836}
    body.dark input,body.dark select,body.dark textarea{background:#3A2836;border-color:#4A3848;color:#F0E4EC}
    body.dark .btn-o{border-color:#6A4060;color:#E48CAC}
    body.dark .btn-ghost{color:#C0A0B8}
    body.dark .nav-tab{color:#A08098}
    body.dark .nav-tab.act{color:var(--rose)}
    body.dark .cal-day.ca:hover{background:#4A2840}
    body.dark .slot.sa{background:#3A2836;color:#C8D8C4;border-color:#5A3850}
    body.dark .tog{background:#3A2836}
    body.dark .tog-btn.ton{background:#4A2840;color:var(--rose)}
    body.dark h1,body.dark h2,body.dark h3,body.dark h4{color:#F4E8F0}
